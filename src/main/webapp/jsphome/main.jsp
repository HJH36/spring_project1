...
%>
   ...
   <div class="container">   
      ...
      <div class="row" style="margin-top:20px;margin-bottom:20px;">
         ...
         <!-- 자주하는 질문 -->
         <div class="col-lg-6 col-md-6">
            <jsp:include page="/jsphome/Faq/faq_main_list.jsp" flush="true" />
         </div>
      </div>

      <div class="row" style="margin-top:20px;margin-bottom:20px;">
         <div class="col-lg-12 col-md-12">
         	<button class = "btn btn-default byn-sm" onclick="visitDay('7');">1주일</button>
         	<button class = "btn btn-default byn-sm" onclick="visitDay('30');">1개월</button>
         	<button class = "btn btn-default byn-sm" onclick="visitDay('180');">6개월</button>
         	<button class = "btn btn-default byn-sm" onclick="visitDay('365');">12개월</button>
         	<button class = "btn btn-default byn-sm" onclick="visitDay('A');">전체</button>
         </div>
      </div>
